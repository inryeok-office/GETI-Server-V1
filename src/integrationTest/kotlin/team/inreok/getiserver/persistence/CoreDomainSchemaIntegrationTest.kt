...
class CoreDomainSchemaIntegrationTest
    ...
    constructor(
        ...
        @Test
        fun `Flyway로 생성한 Schema에는 정확히 43개의 비즈니스 Table이 있다`() {
            ...
            // Push 기기 등록·해제 및 알림 설정(Issue #189)을 위해 notification_devices,
            // notification_settings 2개 Table을 추가해 43개가 되었다(V33 Migration).
            ...
            assertThat(tableCount.toInt()).isEqualTo(43)
        }
