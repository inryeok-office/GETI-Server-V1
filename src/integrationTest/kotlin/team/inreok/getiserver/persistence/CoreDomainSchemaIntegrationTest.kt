...
class CoreDomainSchemaIntegrationTest
    ...
    constructor(
        ...
        @Test
        fun `Flyway로 생성한 Schema에는 정확히 23개의 비즈니스 Table이 있다`() {
            ...
            // majors, tech_stacks, member_majors, member_tech_stacks 4개 Table을 추가해 23개가 되었다.
            ...
            assertThat(tableCount.toInt()).isEqualTo(23)
        }
