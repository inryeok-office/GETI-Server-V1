/**
 * collector Domain(JobCollectionRun)이 operation Domain의 상태 값 Enum(OperationStatus)을
 * 공유하기 위한 Spring Modulith Named Interface 선언이다. Kotlin은 package-level Annotation을
 * 지원하지 않아 이 Java 전용 package-info.java로 선언한다.
 *
