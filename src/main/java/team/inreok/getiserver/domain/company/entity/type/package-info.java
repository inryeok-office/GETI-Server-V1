/**
 * search Domain(JobSearchDocument 색인)이 company Domain의 상태 값 Enum(CompanyType)을 공유하기
 * 위한 Spring Modulith Named Interface 선언이다. Kotlin은 package-level Annotation을 지원하지
 * 않아 이 Java 전용 package-info.java로 선언한다(operation.entity.type의 선례와 동일한 방식,
 * Issue #69).
 *
