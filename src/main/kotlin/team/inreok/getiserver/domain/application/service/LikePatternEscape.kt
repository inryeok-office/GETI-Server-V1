...
// (domain.inquiry.service.escapeLikePattern/domain.member.service.escapeLikePattern/
// domain.company.service.escapeLikePattern과 동일한 관례 -- 이 저장소는 이 작은 Helper를 도메인마다
// 각자 둔다).
