...
/** Discord 공식 문서의 Yellow 색상(Decimal). Embed color는 항상 이 상수를 사용한다. */
const val DISCORD_EMBED_YELLOW = 0xFEE75C
 ...
 * 같은 패턴). 값이 없는 필드(근무지역·고용형태·학력경력·병역특례유형 등)는 현재
 * NormalizedCollectedJob이 해당 정보를 담지 않아 생성하지 않는다("정보 없음" 등으로 채우지
 * 않는다, Issue #62 확장 범위).
 */
